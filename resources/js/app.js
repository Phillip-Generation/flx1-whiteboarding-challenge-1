...
// function genBuzz(low, high) {
//   if (typeof low !== "number") {
//     console.log(`${low} must enter number`);
//   } else if (typeof high !== "number") {
//     console.log(`${high} must be a number`);
//   } else if (low > high) {
//     console.log(`${low} must be smaller than ${high}`);
//   } else console.log(low, high);
